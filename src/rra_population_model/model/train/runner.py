...
def train_main(
    ...
    *,
    ...
    # Defining overture features. Includes both log and non-log version of the features

    overture_features = ['log_or_service_distance',
                         'or_secondary_distance',
                         'log_ow_coastal_inlet_distance',
                         'ow_coastal_ocean_distance',
                         'ow_stream_water_kde_density',
                         'or_tertiary_distance',
                         'ow_coastal_inlet_distance',
                         'log_or_trunk_distance',
                         'log_ow_stream_water_kde_density',
                         'ow_stream_water_distance',
                         'or_track_distance',
                         'ow_waste_and_sewage_distance',
                         'log_or_residential_distance',
                         'or_residential_distance',
                         'ow_manmade_freshwater_distance',
                         'log_or_unknown_distance',
                         'log_or_primary_distance',
                         'log_or_motorway_distance',
                         'log_ow_river_water_distance',
                         'or_primary_distance',
                         'log_or_unclassified_distance',
                         'ow_inland_water_distance',
                         'or_unknown_distance',
                         'or_motorway_distance',
                         'or_trunk_distance',
                         'log_ow_manmade_freshwater_distance',
                         'or_unclassified_distance',
                         'log_ow_stream_water_distance',
                         'log_ow_waste_and_sewage_distance',
                         'log_ow_coastal_ocean_distance',
                         'log_or_secondary_distance',
                         'log_or_track_distance',
                         'log_or_tertiary_distance',
                         'ow_river_water_distance',
                         'or_service_distance',
                         'log_ow_inland_water_distance']
    ...
    model_spec = ModelSpecification(
        ...
        features=[*bd_features, *ntl_feature, *overture_features],
    )
